...
import org.rangenx.common.exception.RangenxException;
...
public class ToolCaller<T> implements Caller<T> {
    ...
    private void handleInvocationException(Exception e, ToolEntity toolEntity) {
        if (e instanceof NoSuchMethodException) {
            throw new RangenxException("No matching method found: " + toolEntity.signature(), e);
        } else {
            throw new RangenxException("Error invoking tool: " + toolEntity.toolName(), e);
        }
    }
